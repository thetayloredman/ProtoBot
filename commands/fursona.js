...
function run(client, message, args, log) {
    ...
    if (!args[0]) {
        ...
        if (!client.fursonas.get(message.author.id)) {
            ...
            const embed = new discord_js_1.default.MessageEmbed().setTitle('Fursona').setDescription('Here is your current fursona information.');
            const fursona = client.fursonas.get(message.author.id);
            embed.addField('Name', (_a = fursona.name) !== null && _a !== void 0 ? _a : '<unset>', true);
            embed.addField('Bio', (_b = fursona.bio) !== null && _b !== void 0 ? _b : '<unset>', true);
            embed.addField('Type', (_c = fursona.type) !== null && _c !== void 0 ? _c : '<unset>');
...
//# sourceMappingURL=fursona.js.map