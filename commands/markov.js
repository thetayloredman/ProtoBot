...
\`\`\``);
        ...
        const chain = new markov_strings_1.default({ stateSize: 2 });
        ...
        message.reply('Sending the privacy policy to your DM...').then((m) => {
            message.author
                .send(`**Privacy info about ProtoBot's markov generation**
