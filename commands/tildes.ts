...
export function run(
    ...
    let tops: [
        number,
        string
    ][] = client.tildes.map((count: number, id: string) => [count, id]);
    ...
    (async () => {
        ...
        msg += '\n';
        msg += ` 1 :: ${u1?.tag ?? '(none)'}${
            t10[0] ? ` with ${t10[0][0]} tildes` : ''
        }\n`;
        msg += ` 2 :: ${u2?.tag ?? '(none)'}${
            t10[1] ? ` with ${t10[1][0]} tildes` : ''
        }\n`;
        msg += ` 3 :: ${u3?.tag ?? '(none)'}${
            t10[2] ? ` with ${t10[2][0]} tildes` : ''
        }\n`;
        msg += ` 4 :: ${u4?.tag ?? '(none)'}${
            t10[3] ? ` with ${t10[3][0]} tildes` : ''
        }\n`;
        msg += ` 5 :: ${u5?.tag ?? '(none)'}${
            t10[4] ? ` with ${t10[4][0]} tildes` : ''
        }\n`;
        msg += ` 6 :: ${u6?.tag ?? '(none)'}${
            t10[5] ? ` with ${t10[5][0]} tildes` : ''
        }\n`;
        msg += ` 7 :: ${u7?.tag ?? '(none)'}${
            t10[6] ? ` with ${t10[6][0]} tildes` : ''
        }\n`;
        msg += ` 8 :: ${u8?.tag ?? '(none)'}${
            t10[7] ? ` with ${t10[7][0]} tildes` : ''
        }\n`;
        msg += ` 9 :: ${u9?.tag ?? '(none)'}${
            t10[8] ? ` with ${t10[8][0]} tildes` : ''
        }\n`;
        msg += `10 :: ${u10?.tag ?? '(none)'}${
            t10[9] ? ` with ${t10[9][0]} tildes` : ''
        }\n`;
        msg += '```';
        message.reply(msg);
    })();
