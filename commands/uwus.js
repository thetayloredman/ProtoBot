...
function run(client, message, args, log) {
    let tops = client.uwus.map((count, id) => [count, id]);
    ...
    (async () => {
        ...
        msg += '===== UWU LEADERBOARD =====\n';
        msg += '\n';
        msg += ` 1 :: ${(_a = u1 === null || u1 === void 0 ? void 0 : u1.tag) !== null && _a !== void 0 ? _a : '(none)'}${t10[0] ? ` with ${t10[0][0]} uwus` : ''}\n`;
        msg += ` 2 :: ${(_b = u2 === null || u2 === void 0 ? void 0 : u2.tag) !== null && _b !== void 0 ? _b : '(none)'}${t10[1] ? ` with ${t10[1][0]} uwus` : ''}\n`;
        msg += ` 3 :: ${(_c = u3 === null || u3 === void 0 ? void 0 : u3.tag) !== null && _c !== void 0 ? _c : '(none)'}${t10[2] ? ` with ${t10[2][0]} uwus` : ''}\n`;
        msg += ` 4 :: ${(_d = u4 === null || u4 === void 0 ? void 0 : u4.tag) !== null && _d !== void 0 ? _d : '(none)'}${t10[3] ? ` with ${t10[3][0]} uwus` : ''}\n`;
        msg += ` 5 :: ${(_e = u5 === null || u5 === void 0 ? void 0 : u5.tag) !== null && _e !== void 0 ? _e : '(none)'}${t10[4] ? ` with ${t10[4][0]} uwus` : ''}\n`;
        msg += ` 6 :: ${(_f = u6 === null || u6 === void 0 ? void 0 : u6.tag) !== null && _f !== void 0 ? _f : '(none)'}${t10[5] ? ` with ${t10[5][0]} uwus` : ''}\n`;
        msg += ` 7 :: ${(_g = u7 === null || u7 === void 0 ? void 0 : u7.tag) !== null && _g !== void 0 ? _g : '(none)'}${t10[6] ? ` with ${t10[6][0]} uwus` : ''}\n`;
        msg += ` 8 :: ${(_h = u8 === null || u8 === void 0 ? void 0 : u8.tag) !== null && _h !== void 0 ? _h : '(none)'}${t10[7] ? ` with ${t10[7][0]} uwus` : ''}\n`;
        msg += ` 9 :: ${(_j = u9 === null || u9 === void 0 ? void 0 : u9.tag) !== null && _j !== void 0 ? _j : '(none)'}${t10[8] ? ` with ${t10[8][0]} uwus` : ''}\n`;
        msg += `10 :: ${(_k = u10 === null || u10 === void 0 ? void 0 : u10.tag) !== null && _k !== void 0 ? _k : '(none)'}${t10[9] ? ` with ${t10[9][0]} uwus` : ''}\n`;
        msg += '```';
        message.reply(msg);
    })();
}
